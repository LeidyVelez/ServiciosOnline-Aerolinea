...
public class ItinerarioController implements Serializable {
    ...
    @EJB
    private co.edu.udea.ServiciosOnline.Ejb.ItinerarioFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ItinerarioCreated"));
    ...
    public Itinerario getItinerario(java.lang.String id) {
    ...
    public static class ItinerarioControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Itinerario) {
                ...
                return getStringKey(o.getIdItinerario());
            } else {
