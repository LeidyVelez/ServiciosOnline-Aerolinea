...
public class VueloController implements Serializable {
    ...
    @EJB
    private co.edu.udea.ServiciosOnline.Ejb.VueloFacade ejbFacade;
    ...
    public Vuelo getVuelo(java.lang.String id) {
    ...
    public static class VueloControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Vuelo) {
                ...
                return getStringKey(o.getIdVuelo());
            } else {
